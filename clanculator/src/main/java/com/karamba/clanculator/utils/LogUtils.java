...
/**
 * LogUtils is a wrapper around standard Android logging that allows for
 * formatters. This prevents the need to wrap all calls to Log in isLoggable,
 * since we no longer have to pre-concatenate strings for logging. In future,
 * this may be part of a shared library. Adopted from UnifiedEmail.
 */
public class LogUtils {
    ...
    /**
     * Used for byte to hex conversion.
     */
    private static final String BYTE_TO_HEX = "0123456789ABCDEF";
    ...
    public static String hideLatLong(double value) {
    ...
    public static StringBuilder byteToHex(StringBuilder sb, int b) {
        b &= 0xFF;
        sb.append(BYTE_TO_HEX.charAt(b >> 4));
        sb.append(BYTE_TO_HEX.charAt(b & 0xF));
        return sb;
    }
